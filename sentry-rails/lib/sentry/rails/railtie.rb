...
module Sentry
  class Railtie < ::Rails::Railtie
    ...
    initializer 'sentry.extend_active_job', before: :eager_load! do |_app|
    ...
    initializer 'sentry.extend_action_cable', before: :eager_load! do |_app|
    ...
    config.after_initialize do |app|
      ...
      if ::Rails.version.to_f >= 7.0 && Sentry.configuration.rails.register_error_subscriber
        register_error_subscriber(app)
      end
    end
    ...
    def extend_controller_methods
      ...
      ActiveSupport.on_load :action_controller do
        ...
        ActionController::Live.prepend Sentry::Rails::Overrides::StreamingReporter
      end
    end
    ...
    def inject_breadcrumbs_logger
      ...
      return unless Sentry.configuration.breadcrumbs_logger.include?(:monotonic_active_support_logger)
      if ::Rails.version.to_f < 6.1
        return warn 'Usage of `monotonic_active_support_logger` require a version of Rails >= 6.1, please upgrade your Rails version or use another logger'
      end
    ...
    def override_streaming_reporter
      ...
      ActiveSupport.on_load :action_view do
        ActionView::StreamingTemplateRenderer::Body.prepend Sentry::Rails::Overrides::StreamingReporter
      end
    end

    def activate_tracing
      return unless Sentry.configuration.tracing_enabled? && Sentry.configuration.instrumenter == :sentry
